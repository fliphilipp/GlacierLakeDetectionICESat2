...
#             props.create_dataset('surface_extent_detection', data=np.array([x for y in self.surface_extent_detection for x in y]), dtype='f8')
#             props.create_dataset('lat_surface_extent_detection', data=np.array([x for y in self.lat_surface_extent_detection for x in y]), dtype='f8')
...
#             props.create_dataset('lat_str', data=self.lat_str.replace('°',''), dtype='S100')
...
#             props.create_dataset('lon_str', data=self.lon_str.replace('°',''), dtype='S100')
#             props.create_dataset('beam_number', data=self.beam_number, dtype='uint8')
#             props.create_dataset('beam_strength', data=self.beam_strength, dtype='S10')
#             props.create_dataset('cycle_number', data=self.cycle_number, dtype='uint8')
#             props.create_dataset('sc_orient', data=self.sc_orient, dtype='S10')
...
#             props.create_dataset('polygon_filename', data=self.polygon_filename, dtype='S300')
#             props.create_dataset('polygon_name', data=self.polygon_name, dtype='S300')
...
#             props.create_dataset('oaurl', data=self.oaurl, dtype='S1000')
#             props.create_dataset('gtx', data=self.gtx, dtype='S10')
#             props.create_dataset('rgt', data=self.rgt, dtype='uint16')
#             props.create_dataset('granule_id', data=self.granule_id, dtype='S39')
#             props.create_dataset('melt_season', data=self.melt_season, dtype='S10')
#             props.create_dataset('ice_sheet', data=self.ice_sheet, dtype='S30')
#         return filename
